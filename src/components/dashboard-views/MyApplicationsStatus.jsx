                    ...
                    if (leave.overrideReason) {
                      ...
                      return (
                        <div className="flex gap-3 p-4 rounded-lg border border-amber-500/30 bg-amber-500/5 items-start mt-6">
                          ...
                          <div className="space-y-1 w-full mt-0.5">
                            <h4 className="text-sm font-semibold text-amber-600">Quota Exceeded</h4>
                            <div className="text-[13px] text-foreground/80 leading-tight">
                              This request exceeds your available {leave.leaveType.name} balance for this year.<br />
                              It requires a special managerial override to be approved.
                            </div>
                          </div>
                        </div>
                      );
